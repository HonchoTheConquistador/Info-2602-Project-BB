...
def view_userprofile():
    ...
    return render_template('userprofile.html',user=jwt_current_user,custom_routines=custom_routines)
...
def delete_custom_routine_route(routine_id):
    ...
    delete_user_routines(jwt_current_user.id, routine_id)
...
def create_custom_routine():
    routine_name = request.form['routine_name']
    routine = add_custom_routine(jwt_current_user.id, routine_name)
    add_user_routines(jwt_current_user.id, routine.routineId) 
